...
const App: React.FC = () => {
  ...
  const BACKEND_SERVER = import.meta.env.BACKEND_URL || 'readmemvpv1-env.eba-qnbz35re.us-east-1.elasticbeanstalk.com'; // Adjust this to your backend server address
